...
\begin{theorem}
  ...
  \begin{proof}
    ...
    \item Leave as an excises
      \footnote{
        $\{\phi_i\}$ - distinct homomorphisms and can be considered as
        distinct \nameref{def:character}s. Therefore by theorem
        \ref{thm:dedekind} the homomorphisms are linearly
        independent i.e. form a basis in $\bar{K}^n$ that prove the
...
\begin{example}[Primitive element]
  ...
  \footnote{
    As soon as extension has degree 4 then a sub-extension should have
