...
\]
This is a general form of \indexref{thm:chineseremainder}.
...
\begin{example}
  ...
  Then by the  \indexref{thm:chineseremainder}
  \footnote{
...
\begin{definition}
  With \indexref{thm:chineseremainder} we have
  \[
  A \cong A/m_1^{k_1} \times \dots \times A/m_r^{k_r}
  \]
...
\begin{theorem}[Artin]
  ...
  \begin{proof}
    ...
    \item We have $\left|G\right| = n$ then
      ...
      direct consequence of \indexref{thm:primitiveelement}. I
      ...
      and I can apply
      \indexref{thm:primitiveelement}. Therefore
