...
\begin{example}
  ...
  \[
  A \cong
  K\left[X\right]/P_1^{k_1} \times \dots
  \times K\left[X\right]/P_r^{k_r},
  \]
  where $K\left[X\right]/P_i^{k_i} = A/m_i^{k_i}$ and
  $m_i = \left( P_i \mod F \right)$ - an ideal.
\end{example}
