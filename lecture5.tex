...
\begin{definition}[Normal extension]
  ...
  \footnote{
    Another good definition of a normal extension is from
    \cite{wiki:normalextrus}. Normal extension $E/K$ is such algebraic
    extension in which every irreducible polynomial $P(X)$ that has a
    single root in $E$ splits in $E$. 
  }
