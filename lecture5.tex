...
\begin{definition}[Normal extension]
  ...
  \footnote{
    There is a question what is the family???
    May be another good definition of a normal extension
    \cite{wiki:normalextrus} can be used. Normal extension $E/K$ is
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    \footnote{
      ...
      result one image for homomorphisms.
    }
    .
    ...
    \footnote{
      ...
      $g(j) \equiv j g = j j^{-1} j' = j'$. Therefore group
