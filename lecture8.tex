...
\begin{claim}
  ...
  \begin{proof}
    ...
    \]
    The \indexref{thm:galoiscorrespondence} says that $\phi$ is
    a \indexref{def:surjection} with kernel
    $Gal\left(L/F\right)$. Therefore by
    \indexref{thm:firstisomorphism} one can get the required
    statement. 
  \end{proof}
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    \footnote{
      ...
      \indexref{thm:lagrange} one can get that
...
\footnote{
  ...
  \indexref{thm:primitiveelement}, $\exists \alpha \in L$
