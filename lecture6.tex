...
\begin{theorem}[Galois correspondence]
  ...
  \begin{proof}
    ...
    \footnote{
      ...
      homomorphism that operates as follows $g_F: F \to F \subset
      \bar{K}$ and therefore it can be extended (by theorem
      \ref{thm:lec2_3}) to homomorphism $g: L \to L \subset \bar{K}$
