...
\footnote{
  ...
  1$. In the case $a k = n$ and $\zeta^a - 1 =0$ and as soon as
  $a < n$ then $\zeta \notin \mu_n^\ast$
}
The number of
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    $\zeta^a$ where $a$ is prime to $n$: $\left(a,n\right)=1$. If we
    can show these for $a$ 
    prime then we can also show this for all $a$. Thus we may
