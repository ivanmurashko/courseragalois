...
\footnote{
  ...
  \nameref{def:primitiverootsofunity}.
}
The number of
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    \footnote{
      ...
      \ref{prop:lec6_cyclotomic}). \nameref{lem:gauss} lemma says that
    ...
    \begin{enumerate}
      ...
      \item $Gal\left(L/K\right)  \hookrightarrow
        ...
        \footnote{
          ...
          Aut\left(\mu_n\right)$ is an \nameref{def:embedding}
          i.e. \nameref{def:injection} that preserves the group
          ...
          that $f\left(g_1 g_2\right) = f\left(g_1 \left) \right(
          g_2\right)$ and that there is a homomorphism. By the way any
          homomorphism should preserve the identity element that was
          shown by Ekaterina.
        }
