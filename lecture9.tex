...
\begin{property}
  ...
  \item If we have the tower of extensions $K \subset F \subset E$
    ...
    \item Consider $T: E \times E \xrightarrow[(x, y) \to
      ...
      non-degenerate $K$-bilinear form
  ...
  \begin{proof}
    ...
    $\mathrm{Tr}_{E/K}\left(xy\right) = 0, \forall y \in E$. But this
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    \]
    this is
    non-degenerate bilinear form (see 4th property
    \ref{property:lec9_norm_trace}) therefore $\exists v_1, \dots,
    v_n$ - dual basis ($\mathbb{Q}$-basis of $K$) and
