...
The following remark is not a part of the lectures
\begin{remark}
  ...
  \begin{proof}
    ...
    $g\sigma_i = \sigma_k$ and $g \sigma_j = \sigma_k$.
    Therefore
    \[
    \sigma_k = g^{-1} \sigma_j = g^{-1} g \sigma_i = \sigma_i
    \]
    that is contradiction.
    $K^\times$ is an \nameref{def:abeliangroup} by  the field definition
    (\ref{def:field}) thus the product in
    \nameref{def:norm} does not depend on the order and the product
