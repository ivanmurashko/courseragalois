...
\begin{property}
  ...
  \begin{proof}
    ...
    argument very similar to that of the \indexref{lem:gauss},
...
\begin{theorem}
  ...
  \begin{proof}
    ...
    \indexref{def:transitive}. By \indexref{thm:chineseremainder}
    ...
    \indexref{thm:primitiveelement} $\exists z \in
    \mathbb{F}_p$ such that $k_1 = \mathbb{F}_p\left(z\right)$
    i.e. $z$ generates $k_i/\mathbb{F}_p$.
    By \indexref{thm:chineseremainder} $\exists y \in A$ such that
