...
\begin{proposition}
  ...
  \begin{proof}
    ...
    \footnote{
      ...
      $\dim K\left[\alpha\right] = d < \infty$. Then
      $y = \sum_{i=0}^d y_i \alpha^i$ and
      $z = \sum_{i=0}^d z_i \alpha^i$ where $y_i, z_i \in K$.
      Thus if $y \ne z$ (i.e.
      $\exists i: y_i \ne z_i$) then
      \[
      x \cdot y  = \sum_{i=0}^d x \cdot y_i \alpha^i \ne
      \sum_{i=0}^d x \cdot z_i \alpha^i =
      x \cdot z
      \]
    }
