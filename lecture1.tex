...
\begin{example}[$K$-algebra is not a field]
  In the example I will show that $K$ algebra is not a field. Consider
  ...
  elements does not have an invert element and as result the $L$ is
  not a field.
  ...
  We have $L'$ is a field and $L' \cong \mathbb{R}$.
