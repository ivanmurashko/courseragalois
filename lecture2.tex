...
\begin{proposition}
  ...
  \begin{proof}
    We can use \indexref{lem:zorn} lemma to prove that any proper ideal is
...
got by means of \indexref{lem:zorn} lemma.
...
\begin{theorem}[About extension of homomorphism]
  ...
  \begin{proof}
    Apply \indexref{lem:zorn} lemma to the following set (of pairs)
    \[
    \mathcal{E} = \left\{
