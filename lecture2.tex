...
\begin{theorem}[On extension of homomorphism]
...
\begin{corollary}[About algebraic closure isomorphism]
  If $\Omega$ and $\Omega'$ are 2 algebraic closures of $K$ then they
  are isomorphic as K-algebras.
  \begin{proof}
    ???
    We have $K \hookrightarrow \Omega$ and $K \hookrightarrow \Omega'$
    I.e. the homomorphism $i: K \to \Omega$ can be extended to
    homomorphism $\psi: \Omega \to \Omega'$. The same is true for
